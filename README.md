...
좌측: Precision–Recall 곡선 / 우측: 정규화 혼동 행렬.

| ![PR Curve](assets/v2/detection_pr_curve.png) | ![Confusion Matrix](assets/v2/confusion_matrix.png) |
| :---: | :---: |
| 클래스별 PR 곡선 (traffic_sign / signboard) | 정규화 혼동 행렬 (대각선 강도) |
