...
**주요 성과 (v2 Stratified Split, 2026-05-30 재학습):**
검출기 W8A8 PTQ 적용 시 mAP 손실 −0.07%p, 추적 MOTA 손실 −1.4%, OCR 정확도 ±0%로
**파이프라인 무손실 압축**을 달성하였으며, Static INT8 QDQ로 CPU 추론 가속도 가능함을 확인하였다.
최적 구성: `yolov8s_signs_w8a8.onnx`(5.4 MB) + ByteTrack + KoreanOCRNet FP32 + TrafficSignNet FP32
= 총 **5.6 MB** (목표 15 MB 대비 **2.7배 여유**).
