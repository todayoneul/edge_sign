...
| :---: | :---: | :---: | :---: | :---: | :---: | :--- |
| E0 FP32 All | 24.3 | 0.219 | 98.5% | 21.2 | 1.0000 | 기준선 |
| E1 W8A8 Det | 13.5 | 0.221 | 98.5% | 24.7 | **1.0335** | — |
| E2 FP32+W8A8 Rec | 21.8 | 0.219 | 98.4% | 23.3 | 1.0198 | E0에 지배됨 |
| E3 W8A8 All | 11.4 | 0.221 | 98.4% | 24.3 | 1.0294 | E5에 지배됨 |
| E4 W4A16 All | 5.7 | 0.105 | 54.6% | 25.2 | 0.7706 | OCR 중간 Pareto |
| **E5 SQ+W8A8** | **11.4** | **0.225** | **98.5%** | 20.5 | 0.9938 | **MOTA+OCR 양쪽 Pareto 최적** |
| E6 BoT-SORT | 11.5 | 0.108 | 98.4% | 20.4 | 0.9922 | E5에 지배됨 |
| E7 W4A16+1-Bit | 5.4 | 0.105 | 0.3% | 25.1 | 0.4392 | 최소 크기(OCR 불가) |

**분석:**
- E5(SmoothQuant+W8A8, 11.4 MB)가 MOTA·OCR 양쪽 Pareto 최적점 — 목표 15 MB 이내 달성
- E3(W8A8 All)과 E5는 동일 크기(11.4 MB)이나 E5가 MOTA(0.221 vs 0.225)·OCR(98.4% vs 98.5%) 모두 우위 → SmoothQuant의 미세한 이득
- Final Score 기준 최선은 E1(1.0335) — 검출기만 W8A8, 인식기 FP32 유지로 속도와 정확도 균형
- E6(BoT-SORT)는 미학습 ReID로 MOTA가 E5 대비 −51.7% 하락하여 E5에 완전 지배됨
- E7(1-Bit, 5.4 MB)는 최소 크기이나 OCR 0.3%로 실사용 불가 — 정보이론적 한계 확인
...
| 구성 | FPS (fake-quant) | FPS (INT8 Static) | 30 FPS 달성 |
| :--- | :---: | :---: | :---: |
| E0 FP32 All | 21.2 | 55.7 | fake: 미달성 / INT8: 달성 |
| E1 W8A8 Det | 24.7 | — | 미달성 |
| E2 FP32+W8A8 Rec | 23.3 | — | 미달성 |
| E3 W8A8 All | 24.3 | **57.7** | fake: 미달성 / **INT8: 달성** |
| E4 W4A16 All | 25.2 | — | 미달성 |
| E5 SQ+W8A8 | 20.5 | — | 미달성 |
| E6 BoT-SORT | 20.4 | — | 미달성 |
| E7 W4A16+1-Bit | 25.1 | — | 미달성 |
