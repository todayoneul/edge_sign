...
| model | MB | mAP50 or top-1 | mAP50-95 | retention | >=99% |
|---|---:|---:|---:|---:|:-:|
| v4_fp32 | 9.806 | 0.4999 | 0.2422 | 1.000 | Y |
| v4_fp16 | 4.972 | 0.4986 | 0.2418 | 0.998 | Y |
| v4_int8_full | 3.099 | 0.0000 | 0.0000 | 0.000 | N |
| v4_int8_head_excl | 3.416 | 0.4826 | 0.2350 | 0.970 | N |
| v4_int8_full_fbias | 2.994 | 0.0000 | 0.0000 | 0.000 | N |
| v4_int8_head_excl_fbias | 3.330 | 0.4824 | 0.2352 | 0.971 | N |
| v3_fp32 | 44.747 | 0.5653 | 0.2808 | 1.000 | Y |
| v3_fp16 | 22.382 | 0.5656 | 0.2805 | 0.999 | Y |
| v3_int8_full | 11.656 | 0.0000 | 0.0000 | 0.000 | N |
| v3_int8_head_excl | 17.998 | 0.5585 | 0.2772 | 0.987 | N |
| v3_int8_full_fbias | 11.552 | 0.0000 | 0.0000 | 0.000 | N |
| v3_int8_head_excl_fbias | 17.912 | 0.5584 | 0.2771 | 0.987 | N |
| rec_fp32 | 0.117 | 0.8082 | - | 1.000 | Y |
| rec_fp16 | 0.060 | 0.8080 | - | 1.000 | Y |
| rec_int8_full | 0.042 | 0.8084 | - | 1.000 | Y |
| rec_int8_full_fbias | 0.039 | 0.8084 | - | 1.000 | Y |
| rec_int8_head_excl | 0.043 | 0.8058 | - | 0.997 | Y |
| rec_int8_head_excl_fbias | 0.041 | 0.8058 | - | 0.997 | Y |
