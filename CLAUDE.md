...
│   │   ├── prepare_dataset.py   # GTSDB/AI Hub → YOLO 포맷 변환
...
python src/detect/prepare_dataset.py --source gtsdb  # YOLO 포맷 변환
...
- **양자화**: 커스텀 PTQ/QAT 구현, ONNX Runtime quantization
