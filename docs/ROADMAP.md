...
- [x] 표준 워크로드 외부 검증 (2026-09-26, 사전 등록 `557dcc3`) — [COCO_VALIDATION.md](../paper_evidence/reports/COCO_VALIDATION.md)
  - YOLO11l, MLPerf COCO safe subset 1,525장으로 사전 예측 P1–P5를 모두 재현함
    - 전체 INT8 붕괴, 출력 연결 텐서 하나로 붕괴
