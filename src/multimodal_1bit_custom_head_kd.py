...
def main():
    ...
    for ckpt_file in glob.glob(os.path.join(SAVE_DIR, "mm_1bit_custom_epoch_*.pth")):
        try:
    ...
    if latest_epoch > 0:
        resume_checkpoint = os.path.join(SAVE_DIR, f"mm_1bit_custom_epoch_{latest_epoch}.pth")
