...
FP16_PATH = (
    DATA_DIR / "mobilevit_quant.onnx"
)  # Keep the _quant name for frontend loading compatibility


def main():
    if not FP32_PATH.exists():
        print(
            f"Error: FP32 MobileViT ONNX model not found at {FP32_PATH}. Please train and export first."
        )
        return
