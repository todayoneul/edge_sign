...
def print_results(fps_map: dict):
    ...
    print(
        f"  {'ID':<4} {'Label':<24} {'mAP@.5':>7} {'mAP@.5:.95':>11} {'MOTA':>7} {'IDF1':>7} {'HOTA':>7} {'IDSW':>5}"
    )
    print("  " + "-" * 78)
    ...
    print(
        f"  {'ID':<4} {'Label':<24} {'OCR Top-1':>10} {'OCR Delta':>10} {'TS Top-1':>9} {'TS Delta':>9}"
    )
    print("  " + "-" * 72)
    for eid in ["E0", "E1", "E2", "E3", "E4", "E5", "E6", "E7"]:
    ...
    print(
        f"  {'ID':<4} {'Label':<24} {'FPS':>7} {'Size(MB)':>9} {'PerfN':>7} {'SpeedN':>7} {'MemN':>6} {'Score':>7}"
    )
    print("  " + "-" * 78)
    for eid in ["E0", "E1", "E2", "E3", "E4", "E5", "E6", "E7"]:
        fps = fps_map.get(eid)
