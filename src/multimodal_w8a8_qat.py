...
def replace_layers_with_w8a8(model):
    for name, module in model.named_children():
        if isinstance(module, nn.Conv2d) and "head" not in name:
            qat_conv = W8A8Conv2d(module.in_channels, module.out_channels, module.kernel_size, 
            ...
            qat_linear = W8A8Linear(module.in_features, module.out_features, module.bias is not None)
